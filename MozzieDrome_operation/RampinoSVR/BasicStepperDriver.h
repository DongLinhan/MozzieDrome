...
public:
    ...
    //DO NOT set accel or deccel 0, or linear routine will get stuck, use CONSTANT_SPEED mode if no change is desired. 
    struct Profile {
...
public:
    ...
    //RH 10/2021 Moved to public: to artificially extend cruising
    // this WAS proteted: because one can call the start methods while CRUISING to get here??
    ...
    //Experimental toogle with external control, see more info on the function
     long nextActionIn(void);
